                    ...
                    <div class="col-md-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class=" right-text-label-form feedback-icon-form" action="{{route('Explore.update',[$data->id])}}" enctype="multipart/form-data">
                                     @method('PATCH')
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                           ...
                                           <a href="{{asset('/public/exploreImage')}}/{{$data->image}}"> 
                                            <img src="{{asset('public/exploreImage')}}/{{$data->image}}" style="height: 80px">
                                        </a>
                                    </div>
                                        </div>
                                    </div>
