                    ...
                    <div class="card-body">
                        <table id="example" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr id="tr-{{$showdata->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div uk-lightbox="animation: fade">
                                            <a href="{{asset('/public/itemImage')}}/{{$showdata->image}}"> <img src="{{asset('/public/itemImage')}}/{{$showdata->image}}" style="height: 50px"></a>
                                     </div>        
                               ...
                               <td><img src="{{asset('/public/itemImage')}}/{{$showdata->banner}}" style="height: 50px"></td>
