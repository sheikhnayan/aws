                        ...
                        <div class="card card-shadow mb-4">
                            <div class="card-header">
                                <div class="card-title" style="float: left;">
                                    Create Life Style mela Offer
                                </div> 
                                <div class="card-title" style="float: right;">
                                    <a href="{{url('offer_setup_life_style_view')}}" class="btn btn-warning">View</a>
...
<div class="col-md-6">
                      ...
                      <div class="control-group"  style="display:none">
                        ...
                        <div class="controls">
                             ...
                             <input type="checkbox" name="type[]" value="7" checked>&nbsp;Lifestyle Mela&nbsp;
